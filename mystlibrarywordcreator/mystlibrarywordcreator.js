/**
 * A script to allow users to graphically manipulate a custom Narayani word for
 * use in Mystcraft, a Minecraft mod. The "extra" circles a non-canon but appear
 * in Mystcraft to foster more variation.
 */
